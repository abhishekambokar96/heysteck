...
// $config['mailpath']         = 'E:/xampp/sendmail/sendmail.exe';
/*$config['smtp_host']        = 'cp-ht-2.webhostbox.net';
$config['smtp_user']        = 'support@notsightseeing.com';
$config['smtp_pass']        = 'support@2017	';*/
